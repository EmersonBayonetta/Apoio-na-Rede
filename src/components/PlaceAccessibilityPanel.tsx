...
export function PlaceAccessibilityPanel({ place, onRoute, route, routeMessage, busy }: {
  ...
  return <article className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5">
    ...
    <p className="text-xs text-slate-500">Você pode traçar a rota mesmo sem informações de acessibilidade cadastradas para este local.</p>
